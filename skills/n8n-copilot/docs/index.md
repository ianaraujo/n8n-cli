...
- [v2.0 breaking changes](https://docs.n8n.io/2-0-breaking-changes/index.md)
...
- [v2.0 Migration tool](https://docs.n8n.io/migration-tool-v2/index.md)
- [2.x](https://docs.n8n.io/release-notes/index.md)
- [Security settings](https://docs.n8n.io/security-settings/index.md)
...
- [Chat Hub](https://docs.n8n.io/advanced-ai/chat-hub/index.md)
- [Human-in-the-loop for tool calls](https://docs.n8n.io/advanced-ai/human-in-the-loop-tools/index.md)
...
- [Set up and use n8n MCP server](https://docs.n8n.io/advanced-ai/mcp/accessing-n8n-mcp-server/index.md)
- [MCP server tools reference](https://docs.n8n.io/advanced-ai/mcp/mcp_tools_reference/index.md)
...
- [Overview](https://docs.n8n.io/data/index.md)
- [Filtering data](https://docs.n8n.io/data/data-filtering/index.md)
- [Pinning and mocking data](https://docs.n8n.io/data/data-pinning/index.md)
- [How n8n structures data](https://docs.n8n.io/data/data-structure/index.md)
- [Data tables](https://docs.n8n.io/data/data-tables/index.md)
- [Expressions for data transformation](https://docs.n8n.io/data/expressions-for-transformation/index.md)
- [Expressions versus data nodes](https://docs.n8n.io/data/expressions/index.md)
- [Approaches for transforming data](https://docs.n8n.io/data/transforming-data/index.md)
- [Referencing data](https://docs.n8n.io/data/data-mapping/index.md)
- [Referencing data in the UI](https://docs.n8n.io/data/data-mapping/data-mapping-ui/index.md)
- [Accessing linked items in the Code node](https://docs.n8n.io/data/data-mapping/itemmatching/index.md)
- [Referencing previous nodes](https://docs.n8n.io/data/data-mapping/referencing-other-nodes/index.md)
- [Linking data items](https://docs.n8n.io/data/data-mapping/data-item-linking/index.md)
- [Preserving linking in the Code node](https://docs.n8n.io/data/data-mapping/data-item-linking/item-linking-code-node/index.md)
- [How items link through workflows](https://docs.n8n.io/data/data-mapping/data-item-linking/item-linking-concepts/index.md)
...
- [Expression Reference](https://docs.n8n.io/data/expression-reference/index.md)
- [Array](https://docs.n8n.io/data/expression-reference/array/index.md)
- [BinaryFile](https://docs.n8n.io/data/expression-reference/binaryfile/index.md)
- [Boolean](https://docs.n8n.io/data/expression-reference/boolean/index.md)
- [CustomData](https://docs.n8n.io/data/expression-reference/customdata/index.md)
- [Date](https://docs.n8n.io/data/expression-reference/date/index.md)
- [DateTime](https://docs.n8n.io/data/expression-reference/datetime/index.md)
- [ExecData](https://docs.n8n.io/data/expression-reference/execdata/index.md)
- [HTTPResponse](https://docs.n8n.io/data/expression-reference/httpresponse/index.md)
- [Item](https://docs.n8n.io/data/expression-reference/item/index.md)
- [NodeInputData](https://docs.n8n.io/data/expression-reference/nodeinputdata/index.md)
- [NodeOutputData](https://docs.n8n.io/data/expression-reference/nodeoutputdata/index.md)
- [Number](https://docs.n8n.io/data/expression-reference/number/index.md)
- [Object](https://docs.n8n.io/data/expression-reference/object/index.md)
- [PrevNodeData](https://docs.n8n.io/data/expression-reference/prevnodedata/index.md)
- [Root](https://docs.n8n.io/data/expression-reference/root/index.md)
- [String](https://docs.n8n.io/data/expression-reference/string/index.md)
- [WorkflowData](https://docs.n8n.io/data/expression-reference/workflowdata/index.md)
- [Binary data](https://docs.n8n.io/data/specific-data-types/binary-data/index.md)
- [Query JSON with JMESPath](https://docs.n8n.io/data/specific-data-types/jmespath/index.md)
- [Date and time with Luxon](https://docs.n8n.io/data/specific-data-types/luxon/index.md)
...
- [Credential overwrites](https://docs.n8n.io/hosting/configuration/credential-overwrites/index.md)
- [External hooks](https://docs.n8n.io/hosting/configuration/external-hooks/index.md)
...
- [Configure a custom workflow templates library](https://docs.n8n.io/hosting/configuration/configuration-examples/custom-templates/index.md)
...
- [Pre-configure Microsoft OAuth credentials](https://docs.n8n.io/hosting/configuration/configuration-examples/microsoft-oauth-credential-overwrites/index.md)
...
- [AI Assistant](https://docs.n8n.io/hosting/configuration/environment-variables/ai-assistant/index.md)
...
- [SSRF protection](https://docs.n8n.io/hosting/configuration/environment-variables/ssrf-protection/index.md)
...
- [Workflow history](https://docs.n8n.io/hosting/configuration/environment-variables/workflow-history/index.md)
...
- [OpenShift CRC](https://docs.n8n.io/hosting/installation/server-setups/openshift-crc/index.md)
...
- [Overview](https://docs.n8n.io/hosting/oem-deployment/index.md)
- [Managing workflows](https://docs.n8n.io/hosting/oem-deployment/managing-workflows/index.md)
- [Prerequisites](https://docs.n8n.io/hosting/oem-deployment/prerequisites/index.md)
...
- [Restrict account registration to email-verified users](https://docs.n8n.io/hosting/securing/restrict-by-email-verification/index.md)
...
- [SSRF protection](https://docs.n8n.io/hosting/securing/ssrf-protection/index.md)
...
- [Databricks](https://docs.n8n.io/integrations/builtin/app-nodes/n8n-nodes-base.databricks/index.md)
...
- [Azure AI Search Vector Store](https://docs.n8n.io/integrations/builtin/cluster-nodes/root-nodes/n8n-nodes-langchain.vectorstoreazureaisearch/index.md)
- [Chroma Vector Store](https://docs.n8n.io/integrations/builtin/cluster-nodes/root-nodes/n8n-nodes-langchain.vectorstorechroma/index.md)
...
- [Microsoft Agent 365 Trigger](https://docs.n8n.io/integrations/builtin/cluster-nodes/root-nodes/n8n-nodes-langchain.microsoftagent365trigger/index.md)
...
- [Embeddings Lemonade](https://docs.n8n.io/integrations/builtin/cluster-nodes/sub-nodes/n8n-nodes-langchain.embeddingslemonade/index.md)
...
- [Lemonade Chat Model](https://docs.n8n.io/integrations/builtin/cluster-nodes/sub-nodes/n8n-nodes-langchain.lmchatlemonade/index.md)
...
- [Lemonade Model](https://docs.n8n.io/integrations/builtin/cluster-nodes/sub-nodes/n8n-nodes-langchain.lmlemonade/index.md)
...
- [Chat](https://docs.n8n.io/integrations/builtin/core-nodes/n8n-nodes-langchain.chat/index.md)
- [Guardrails](https://docs.n8n.io/integrations/builtin/core-nodes/n8n-nodes-langchain.guardrails/index.md)
- [MCP Client](https://docs.n8n.io/integrations/builtin/core-nodes/n8n-nodes-langchain.mcpClient/index.md)
...
- [Row operations](https://docs.n8n.io/integrations/builtin/core-nodes/n8n-nodes-base.datatable/rows/index.md)
- [Table operations](https://docs.n8n.io/integrations/builtin/core-nodes/n8n-nodes-base.datatable/tables/index.md)
...
- [Azure AI Search credentials](https://docs.n8n.io/integrations/builtin/credentials/azureaisearch/index.md)
...
- [Chroma credentials](https://docs.n8n.io/integrations/builtin/credentials/chroma/index.md)
...
- [Databricks credentials](https://docs.n8n.io/integrations/builtin/credentials/databricks/index.md)
...
- [Lemonade credentials](https://docs.n8n.io/integrations/builtin/credentials/lemonade/index.md)
...
- [Microsoft Agent 365 credentials](https://docs.n8n.io/integrations/builtin/credentials/microsoftagent365/index.md)
...
- [1.x](https://docs.n8n.io/release-notes/1-x/index.md)
...
- [Custom roles](https://docs.n8n.io/user-management/rbac/custom-roles/index.md)
...
- [Azure AD SAML setup](https://docs.n8n.io/user-management/saml/azuread/index.md)
...
- [Save and publish](https://docs.n8n.io/workflows/publish/index.md)
...
- [Redact execution data](https://docs.n8n.io/workflows/executions/execution-data-redaction/index.md)
